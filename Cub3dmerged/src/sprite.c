...
/*   Updated: 2020/11/07 14:37:38 by msantos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sprite_drawing(t_raycaster *rc, int i)
{
	...
	{
		rc->sprtexx = (int)(256 * (rc->stripe - (-rc->spritewidth / 2 + rc->spritescreenx)) * rc->tex_width / rc->spritewidth) / 256;
		y = rc->drawstarty;
...
void	sprite_casting2(t_raycaster *rc)
{
	...
	rc->transformx = rc->invdet * (rc->diry * rc->spritex - rc->dirx *
															rc->spritey);
	rc->transformy = rc->invdet * (-rc->player_plane_y * rc->spritex + rc->player_plane_x * rc->spritey);
