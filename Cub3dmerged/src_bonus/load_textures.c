...
{
	rc->tex[6].img = mlx_xpm_file_to_image(rc->mlx_ptr, "textures/inferno/sprite.xpm",
			&rc->tex_width, &rc->tex_height);
	rc->tex[6].data = mlx_get_data_addr(rc->tex[6].img, &rc->tex[6].bpp,
			&rc->tex[6].size_l, &rc->tex[6].endian);
	rc->tex[7].img = mlx_xpm_file_to_image(rc->mlx_ptr, "textures/inferno/cielo.xpm",
			&rc->tex_width, &rc->tex_height);
...
{
	rc->tex[1].img = mlx_xpm_file_to_image(rc->mlx_ptr, "textures/inferno/pared1.xpm",
			&rc->tex_width, &rc->tex_height);
	rc->tex[1].data = mlx_get_data_addr(rc->tex[1].img, &rc->tex[1].bpp,
			&rc->tex[1].size_l, &rc->tex[1].endian);
	rc->tex[2].img = mlx_xpm_file_to_image(rc->mlx_ptr, "textures/inferno/pared2.xpm",
			&rc->tex_width, &rc->tex_height);
	...
	rc->tex[4].img = mlx_xpm_file_to_image(rc->mlx_ptr, "textures/inferno/suelo.xpm",
			&rc->tex_width, &rc->tex_height);
