...
/*   Updated: 2020/11/17 12:39:01 by msantos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	rc->tex[1].img = mlx_xpm_file_to_image(rc->mlx_ptr,
	"textures/cs/pared1.xpm", &rc->tex_width, &rc->tex_height);
	rc->tex[1].data = mlx_get_data_addr(rc->tex[1].img, &rc->tex[1].bpp,
			&rc->tex[1].size_l, &rc->tex[1].endian);
	rc->tex[2].img = mlx_xpm_file_to_image(rc->mlx_ptr,
	"textures/cs/pared3.xpm", &rc->tex_width, &rc->tex_height);
	...
	rc->tex[4].img = mlx_xpm_file_to_image(rc->mlx_ptr, "textures/cs/suelo.xpm",
			&rc->tex_width, &rc->tex_height);
